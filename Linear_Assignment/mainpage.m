...
% Last Modified by GUIDE v2.5 09-Dec-2018 23:23:15
...
% --- Executes on button press in playbutt.
function playbutt_Callback(hObject, eventdata, handles)
% hObject    handle to playbutt (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
close(mainpage);
gamepage;

% --- Executes on button press in invertbutt.
function invertbutt_Callback(hObject, eventdata, handles)
% hObject    handle to invertbutt (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
close(mainpage);
inverse;

% --- Executes on button press in jordanbutt.
function jordanbutt_Callback(hObject, eventdata, handles)
% hObject    handle to jordanbutt (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
close(mainpage);
prac;      

% --- Executes on button press in howtoplaybutt.
function howtoplaybutt_Callback(hObject, eventdata, handles)
% hObject    handle to howtoplaybutt (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
close(mainpage);
htppage; 
